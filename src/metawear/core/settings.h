 ...
 */
typedef enum {
    MBL_WHITELIST_FILTER_ALLOW_FROM_ANY = 0,
    MBL_WHITELIST_FILTER_SCAN_REQUESTS = 1,
    MBL_WHITELIST_FILTER_CONNECTION_REQUESTS = 2,
    MBL_WHITELIST_FILTER_SCAN_AND_CONNECTION_REQUESTS = 3
